...
sed -i -- "s/{yourSpaApplicationClientId}/$CLIENT_ID/g" okta-hosted-login/src/.samples.config.js

sed -i -- "s/{yourOktaDomain}/$OKTA_DOMAIN/g" custom-login/src/.samples.config.js
sed -i -- "s/{yourSpaApplicationClientId}/$CLIENT_ID/g" custom-login/src/.samples.config.js
